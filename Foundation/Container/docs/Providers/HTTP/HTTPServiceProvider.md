...
Think of it like providing paper and pens to a writer. Responses and streams are the materials used to “write” HTTP
output.
...
Your middleware needs to return a response. It typehints `ResponseFactoryInterface` and creates a response without
caring about the concrete implementation. This provider makes that possible by registering a factory and a default
response binding.
