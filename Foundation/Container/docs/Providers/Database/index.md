...
Technically, these providers register database clients, connection factories, repositories, and related configuration
bindings. They typically choose lifetimes carefully (often singleton for connection factories, scoped for request-bound
transactions).
...
Database providers register base DB services. Higher-level application services can then typehint DB interfaces and let
the container inject the correct implementation.
