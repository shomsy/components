...
### Method: test_it_detects_simple_circular_dependency()

#### Technical Explanation (test_it_detects_simple_circular_dependency)
...
### Method: __construct(CircularA $a)
