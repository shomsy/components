...
High-level invoker actions that provide a stable API for the rest of the container to invoke callables with automatic
dependency resolution. It exists to keep invocation usage consistent and to hide executor wiring details.

### For Humans: What This Means (Represent)

This is the friendly front door to “smart call.” You use these classes instead of talking to the low-level executor
directly.
