...
In-memory helpers that cache reflection objects for callables during invocation. It exists because reflection is expensive and callables are often invoked repeatedly.
