...
Exception types and exception contracts used across the Container component. They exist to make failure modes consistent
and PSR-compatible.
...
Specialized exceptions extend a shared base so they can be caught broadly or narrowly depending on your needs.
Interfaces provide compatibility with external tooling.
