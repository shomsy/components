...
Enums that encode container-level choices as type-safe values (like service lifetimes). They exist to avoid fragile
string constants and to make intent explicit.
...
Definitions, lifecycle resolvers, and caching strategies use these enum values to decide how to store and reuse
instances.
