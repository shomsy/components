...
## Terminology (MANDATORY, EXPANSIVE)- **Singleton lifetime**: One instance reused across the container’s lifetime.
...
A configuration service is stateless and expensive to create. The class is marked `#[Singleton]`. During registration or
analysis, the container recognizes this and binds it as a singleton.
