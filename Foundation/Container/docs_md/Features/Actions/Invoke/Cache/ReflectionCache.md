...
## Terminology
- **ReflectionFunctionAbstract**: Base reflection type for functions and methods.
...
## Story Example
A route handler is called hundreds of times. Without caching, each invocation would create reflection. With `ReflectionCache`, the executor creates reflection once and reuses it.
