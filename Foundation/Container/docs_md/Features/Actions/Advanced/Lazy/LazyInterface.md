...
## Terminology
**Lazy Contract**: A standardized interface that defines how lazy initialization should work, ensuring consistency across different lazy implementations. In this file, this is what the interface provides. It matters because it enables interchangeable lazy implementations.
