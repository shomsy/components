...
## Terminology
**Lazy Initialization**: The practice of deferring object creation until the object is actually needed. In this file, `getOrInit()` implements this pattern. It matters because it improves startup performance and reduces memory usage.
