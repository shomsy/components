...
namespace Avax\Container\Tests {
    ...
    final class KernelTest extends TestCase
    {
         ...
         */
        public function test_kernel_middleware_config_fallbacks_to_empty_array(): void
        {
         ...
         * @throws ReflectionException
         */
        public function test_kernel_middleware_config_resolver_failure_falls_back_to_empty_array(): void
        {
            $kernel = new Kernel(
