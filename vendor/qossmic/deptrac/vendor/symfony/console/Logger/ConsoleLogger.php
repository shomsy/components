 ...
 */
namespace DEPTRAC_INTERNAL\Symfony\Component\Console\Logger;

use DEPTRAC_INTERNAL\Psr\Log\AbstractLogger;
use DEPTRAC_INTERNAL\Psr\Log\InvalidArgumentException;
use DEPTRAC_INTERNAL\Psr\Log\LogLevel;
