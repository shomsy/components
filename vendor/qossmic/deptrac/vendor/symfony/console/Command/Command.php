 ...
 */
namespace DEPTRAC_INTERNAL\Symfony\Component\Console\Command;

use DEPTRAC_INTERNAL\Symfony\Component\Console\Application;
use DEPTRAC_INTERNAL\Symfony\Component\Console\Attribute\AsCommand;
...
use DEPTRAC_INTERNAL\Symfony\Component\Console\Helper\HelperInterface;
...
class Command
{
    ...
    public static function getDefaultName() : ?string
    {
        ...
        \DEPTRAC_INTERNAL\trigger_deprecation('symfony/console', '6.1', 'Relying on the static property "$defaultName" for setting a command name is deprecated. Add the "%s" attribute to the "%s" class instead.', AsCommand::class, static::class);
    ...
    public static function getDefaultDescription() : ?string
    {
        ...
        \DEPTRAC_INTERNAL\trigger_deprecation('symfony/console', '6.1', 'Relying on the static property "$defaultDescription" for setting a command description is deprecated. Add the "%s" attribute to the "%s" class instead.', AsCommand::class, static::class);
