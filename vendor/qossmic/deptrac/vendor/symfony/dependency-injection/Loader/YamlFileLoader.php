...
use DEPTRAC_INTERNAL\Symfony\Component\Yaml\Parser as YamlParser;
...
class YamlFileLoader extends FileLoader
{
    ...
    {
        if (!\class_exists(\DEPTRAC_INTERNAL\Symfony\Component\Yaml\Parser::class)) {
    ...
    private function resolveServices(mixed $value, string $file, bool $isParameter = \false) : mixed
    {
        if ($value instanceof TaggedValue) {
            ...
            if ('service_locator' === $value->getTag()) {
                ...
                $argument = $this->resolveServices($argument, $file, $isParameter);
                if (isset($argument[0])) {
                    \DEPTRAC_INTERNAL\trigger_deprecation('symfony/dependency-injection', '6.3', 'Using integers as keys in a "!service_locator" tag is deprecated. The keys will default to the IDs of the original services in 7.0.');
                }
