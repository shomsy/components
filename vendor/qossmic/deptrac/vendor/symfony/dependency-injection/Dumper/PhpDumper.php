...
use DEPTRAC_INTERNAL\Composer\Autoload\ClassLoader;
...
use DEPTRAC_INTERNAL\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use DEPTRAC_INTERNAL\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use DEPTRAC_INTERNAL\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
...
use DEPTRAC_INTERNAL\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
...
use DEPTRAC_INTERNAL\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface;
use DEPTRAC_INTERNAL\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\LazyServiceDumper;
use DEPTRAC_INTERNAL\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use DEPTRAC_INTERNAL\Symfony\Component\DependencyInjection\Loader\FileLoader;
...
use DEPTRAC_INTERNAL\Symfony\Component\DependencyInjection\ServiceLocator as BaseServiceLocator;
use DEPTRAC_INTERNAL\Symfony\Component\DependencyInjection\TypedReference;
use DEPTRAC_INTERNAL\Symfony\Component\DependencyInjection\Variable;
use DEPTRAC_INTERNAL\Symfony\Component\ErrorHandler\DebugClassLoader;
...
class PhpDumper extends Dumper
{
    ...
    public function dump(array $options = []) : string|array
    {
        ...
        if (isset($options['inline_factories'])) {
            ...
            \DEPTRAC_INTERNAL\trigger_deprecation('symfony/dependency-injection', '6.3', 'Option "inline_factories_parameter" passed to "%s()" is deprecated, use option "inline_factories" instead.', __METHOD__);
        ...
        if (isset($options['inline_class_loader'])) {
            ...
            \DEPTRAC_INTERNAL\trigger_deprecation('symfony/dependency-injection', '6.3', 'Option "inline_class_loader_parameter" passed to "%s()" is deprecated, use option "inline_class_loader" instead.', __METHOD__);
...
use DEPTRAC_INTERNAL\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
use DEPTRAC_INTERNAL\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
use DEPTRAC_INTERNAL\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;
...
EOF;
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (!isset($this->expressionLanguage)) {
            if (!\class_exists(\DEPTRAC_INTERNAL\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
