 ...
 */
namespace DEPTRAC_INTERNAL\Symfony\Component\DependencyInjection\ParameterBag;
...
class ParameterBag implements ParameterBagInterface
{
    ...
    public function get(string $name) : array|bool|string|int|float|\UnitEnum|null
    {
        ...
        if (isset($this->deprecatedParameters[$name])) {
            \DEPTRAC_INTERNAL\trigger_deprecation(...$this->deprecatedParameters[$name]);
        }
    ...
    {
        if (\is_numeric($name)) {
            \DEPTRAC_INTERNAL\trigger_deprecation('symfony/dependency-injection', '6.2', \sprintf('Using numeric parameter name "%s" is deprecated and will throw as of 7.0.', $name));
