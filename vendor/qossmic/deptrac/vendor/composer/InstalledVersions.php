 ...
 */
namespace DEPTRAC_INTERNAL\Composer;

use DEPTRAC_INTERNAL\Composer\Autoload\ClassLoader;
use DEPTRAC_INTERNAL\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('DEPTRAC_INTERNAL\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
