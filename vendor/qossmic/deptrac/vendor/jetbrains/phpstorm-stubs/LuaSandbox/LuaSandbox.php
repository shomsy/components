 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('DEPTRAC_INTERNAL\\LuaSandbox', 'LuaSandbox', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('DEPTRAC_INTERNAL\\LuaSandboxFunction', 'LuaSandboxFunction', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('DEPTRAC_INTERNAL\\LuaSandboxError', 'LuaSandboxError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('DEPTRAC_INTERNAL\\LuaSandboxRuntimeError', 'LuaSandboxRuntimeError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('DEPTRAC_INTERNAL\\LuaSandboxFatalError', 'LuaSandboxFatalError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('DEPTRAC_INTERNAL\\LuaSandboxErrorError', 'LuaSandboxErrorError', \false);
/**
 ...
 * @see LuaSandbox::setMemoryLimit()
 */
\class_alias('DEPTRAC_INTERNAL\\LuaSandboxMemoryError', 'LuaSandboxMemoryError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('DEPTRAC_INTERNAL\\LuaSandboxSyntaxError', 'LuaSandboxSyntaxError', \false);
/**
 ...
 * @see LuaSandbox::setCPULimit()
 */
\class_alias('DEPTRAC_INTERNAL\\LuaSandboxTimeoutError', 'LuaSandboxTimeoutError', \false);
