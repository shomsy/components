 ...
 * @link https://secure.php.net/manual/en/class.zmq.php
 */
\class_alias('DEPTRAC_INTERNAL\\ZMQ', 'ZMQ', \false);
/**
 * Class ZMQContext
 ...
 * @link https://secure.php.net/manual/en/class.zmqcontext.php
 */
\class_alias('DEPTRAC_INTERNAL\\ZMQContext', 'ZMQContext', \false);
/**
 * Class ZMQSocket
 ...
 * @link https://secure.php.net/manual/en/class.zmqsocket.php
 */
\class_alias('DEPTRAC_INTERNAL\\ZMQSocket', 'ZMQSocket', \false);
/**
 * Class ZMQPoll
 ...
 * @link https://secure.php.net/manual/en/class.zmqpoll.php
 */
\class_alias('DEPTRAC_INTERNAL\\ZMQPoll', 'ZMQPoll', \false);
/**
 * Class ZMQDevice
 ...
 * @link https://secure.php.net/manual/en/class.zmqdevice.php
 */
\class_alias('DEPTRAC_INTERNAL\\ZMQDevice', 'ZMQDevice', \false);
class ZMQException extends \Exception
{
}
\class_alias('DEPTRAC_INTERNAL\\ZMQException', 'ZMQException', \false);
class ZMQContextException extends \ZMQException
{
}
\class_alias('DEPTRAC_INTERNAL\\ZMQContextException', 'ZMQContextException', \false);
class ZMQSocketException extends \ZMQException
{
}
\class_alias('DEPTRAC_INTERNAL\\ZMQSocketException', 'ZMQSocketException', \false);
class ZMQPollException extends \ZMQException
{
}
\class_alias('DEPTRAC_INTERNAL\\ZMQPollException', 'ZMQPollException', \false);
class ZMQDeviceException extends \ZMQException
{
}
\class_alias('DEPTRAC_INTERNAL\\ZMQDeviceException', 'ZMQDeviceException', \false);
