...
// Start of svn v.1.0.1
\class_alias('DEPTRAC_INTERNAL\\Svn', 'Svn', \false);
class SvnWc
{
    public const NONE = 1;
...
\class_alias('DEPTRAC_INTERNAL\\SvnWc', 'SvnWc', \false);
class SvnWcSchedule
{
...
\class_alias('DEPTRAC_INTERNAL\\SvnWcSchedule', 'SvnWcSchedule', \false);
class SvnNode
{
    public const NONE = 0;
    public const FILE = 1;
...
\class_alias('DEPTRAC_INTERNAL\\SvnNode', 'SvnNode', \false);
/**
 * (PECL svn &gt;= 0.1.0)<br/>
