...
final class Manager
{
     ...
     */
    public final function __construct(?string $uri = null, ?array $options = null, ?array $driverOptions = null)
    {
    }
     ...
     */
    public final function executeBulkWrite(string $namespace, BulkWrite $bulk, array|WriteConcern|null $options = null) : WriteResult
    {
    }
    /**
     ...
     * @since 1.4.0 added $options argument
     */
    public final function executeCommand(string $db, Command $command, array|ReadPreference|null $options = null) : Cursor
    {
    }
    /**
     ...
     * @since 1.4.0 added $options argument
     */
    public final function executeQuery(string $namespace, Query $query, array|ReadPreference|null $options = null) : Cursor
    {
    }
    /**
     ...
     * @since 1.4.0
     */
    public final function executeReadCommand(string $db, Command $command, ?array $options = null) : Cursor
    {
    }
    /**
     ...
     * @since 1.4.0
     */
    public final function executeReadWriteCommand(string $db, Command $command, ?array $options = null) : Cursor
    {
    }
    /**
     ...
     * @since 1.4.0
     */
    public final function executeWriteCommand(string $db, Command $command, ?array $options = null) : Cursor
    {
    }
    /**
     ...
     * @since 1.14.0
     */
    public final function getEncryptedFieldsMap() : array|object|null
    {
    }
    /**
     ...
     * @throws InvalidArgumentException on argument parsing errors.
     */
    public final function getReadConcern() : ReadConcern
    {
    }
    /**
     ...
     */
    public final function getReadPreference() : ReadPreference
    {
    }
    /**
     ...
     * @return WriteConcern
     */
    public final function getWriteConcern() : WriteConcern
    {
    }
    /**
     ...
     * @since 1.4.0
     */
    public final function startSession(?array $options = null)
    {
    }
    /**
     ...
     * @since 1.10.0
     */
    public final function addSubscriber(Subscriber $subscriber) : void
    {
    }
    /**
     ...
     * @since 1.10.0
     */
    public final function removeSubscriber(Subscriber $subscriber) : void
    {
    }
}
