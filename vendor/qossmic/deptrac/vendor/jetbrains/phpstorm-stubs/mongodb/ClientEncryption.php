...
final class ClientEncryption
{
     ...
     * @since 1.15.0
     */
    public final function addKeyAltName(Binary $keyId, string $keyAltName) : ?object
    {
    }
    /**
     ...
     */
    public final function createDataKey(string $kmsProvider, ?array $options = null) : Binary
    {
    }
    /**
     ...
     */
    public final function decrypt(Binary $keyVaultClient)
    {
    }
    /**
     ...
     * @since 1.15.0
     */
    public final function deleteKey(Binary $keyId) : object
    {
    }
    /**
     ...
     */
    public final function encrypt($value, ?array $options = null) : Binary
    {
    }
    /**
     ...
     * @since 1.16.0
     */
    public final function encryptExpression(array|object $expr, ?array $options = null) : object
    {
    }
    /**
     * Gets a key document
     ...
     * @since 1.15.0
     */
    public final function getKey(Binary $keyId) : ?object
    {
    }
    /**
     ...
     * @since 1.15.0
     */
    public final function getKeyByAltName(string $keyAltName) : ?object
    {
    }
    /**
     ...
     * @since 1.15.0
     */
    public final function getKeys() : Cursor
    {
    }
    /**
     ...
     * @since 1.15.0
     */
    public final function removeKeyAltName(Binary $keyId, string $keyAltName) : ?object
    {
    }
    /**
     * Rewraps data keys
     ...
     * @since 1.16.0
     */
    public final function rewrapManyDataKey(array|object $filter, ?array $options = null) : object
    {
    }
}
