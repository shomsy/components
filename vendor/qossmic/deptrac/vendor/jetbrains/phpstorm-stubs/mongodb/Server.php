...
final class Server
{
     ...
     * @since 1.0.0
     */
    public final function executeBulkWrite(string $namespace, BulkWrite $bulkWrite, array|WriteConcern|null $options = null) : WriteResult
    {
    }
    /**
     ...
     * @throws InvalidArgumentException on argument parsing errors.
     */
    public final function getLatency() : int
    {
    }
    /**
     ...
     * @since 1.13.0
     */
    public final function getServerDescription() : ServerDescription
    {
    }
    /**
     ...
     * @throws InvalidArgumentException on argument parsing errors.
     */
    public final function isArbiter() : bool
    {
    }
    /**
     ...
     * @throws InvalidArgumentException on argument parsing errors.
     */
    public final function isPassive() : bool
    {
    }
    /**
     ...
     * @throws InvalidArgumentException on argument parsing errors.
     */
    public final function isSecondary() : bool
    {
    }
}
