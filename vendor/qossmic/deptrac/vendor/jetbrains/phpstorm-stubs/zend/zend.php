...
// Start of Zend Extensions
\class_alias('DEPTRAC_INTERNAL\\ZendAPI_Queue', 'ZendAPI_Queue', \false);
/**
 ...
 * For simplicity, a job can be added directly to a queue and without creating an instant of a Queue object
 */
\class_alias('DEPTRAC_INTERNAL\\ZendAPI_Job', 'ZendAPI_Job', \false);
/**
...
\class_alias('DEPTRAC_INTERNAL\\java', 'java', \false);
class JavaException
{
    /**
...
\class_alias('DEPTRAC_INTERNAL\\JavaException', 'JavaException', \false);
