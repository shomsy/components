 ...
 * @see https://php.net/manual/en/class.event.php
 */
\class_alias('DEPTRAC_INTERNAL\\Event', 'Event', \false);
//  The EventBase class
/**
 * EventBase.
 ...
 * @see https://php.net/manual/en/class.eventbase.php
 */
\class_alias('DEPTRAC_INTERNAL\\EventBase', 'EventBase', \false);
 ...
 * @see https://php.net/manual/en/class.eventbuffer.php
 */
\class_alias('DEPTRAC_INTERNAL\\EventBuffer', 'EventBuffer', \false);
 ...
 * @see https://php.net/manual/en/class.eventbufferevent.php
 */
\class_alias('DEPTRAC_INTERNAL\\EventBufferEvent', 'EventBufferEvent', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventconfig.php
 */
\class_alias('DEPTRAC_INTERNAL\\EventConfig', 'EventConfig', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventdnsbase.php
 */
\class_alias('DEPTRAC_INTERNAL\\EventDnsBase', 'EventDnsBase', \false);
// The EventHttp class
/**
 * EventHttp.
 ...
 * @see https://secure.php.net/manual/en/class.eventhttp.php
 */
\class_alias('DEPTRAC_INTERNAL\\EventHttp', 'EventHttp', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventhttpconnection.php
 */
\class_alias('DEPTRAC_INTERNAL\\EventHttpConnection', 'EventHttpConnection', \false);
...
// The EventHttpRequest class
\class_alias('DEPTRAC_INTERNAL\\EventHttpRequest', 'EventHttpRequest', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventlistener.php
 */
\class_alias('DEPTRAC_INTERNAL\\EventListener', 'EventListener', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventsslcontext.php
 */
\class_alias('DEPTRAC_INTERNAL\\EventSslContext', 'EventSslContext', \false);
// The EventUtil class
/**
 * EventUtil.
 ...
 * @see https://secure.php.net/manual/en/class.eventutil.php
 */
\class_alias('DEPTRAC_INTERNAL\\EventUtil', 'EventUtil', \false);
